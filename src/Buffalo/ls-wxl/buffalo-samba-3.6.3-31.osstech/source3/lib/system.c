...
/* 2012/06/27 t.saito change for debug */
#if 1
#define USING_SYSCALL_FALLOCATE
#include <linux/unistd.h>
#include <linux/falloc.h>
#endif
/* 2012/06/27 t.saito change end */
...
#if defined(USING_SYSCALL_FALLOCATE)
	DEBUG(2,("call posix_fallocate (but change to syscall fallocate)\n"));
...
{
#ifdef USING_SYSCALL_FALLOCATE
	DEBUG(2,("call linux sys_fallocate (but does not use glibc)\n"));
	int lmode;
	switch (mode) {
