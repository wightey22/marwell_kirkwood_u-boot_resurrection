...
static struct parm_struct parm_table[] = {
	...
	},
	{
        ...
        {
		.label          = "ignore syssetgroups error",
		.type           = P_BOOL,
		.p_class        = P_GLOBAL,
		.ptr            = &Globals.bIgnoreSysSetGroupsError,
		.special        = NULL,
		.enum_list      = NULL,
		.flags          = FLAG_ADVANCED | FLAG_SHARE | FLAG_GLOBAL,
	},
...
static void init_globals(bool reinit_globals)
{
	...
	Globals.bIgnoreSysSetGroupsError = false;
...
FN_GLOBAL_BOOL(lp_ignore_syssetgroups_error, &Globals.bIgnoreSysSetGroupsError)
