...
public class Villa implements ADBM {
   ...
   */
  public void put(byte[] key, byte[] val, int dmode) throws VillaException {
    if(index < 0) throw new VillaException();
    synchronized(ADBM.class){
   ...
   */
  public void put(byte[] key, byte[] val) throws VillaException {
    put(key, val, DOVER);
  }
  /**
   ...
   */
  public void out(byte[] key) throws VillaException {
    if(index < 0) throw new VillaException();
    synchronized(ADBM.class){
  ...
  public byte[] get(byte[] key) throws VillaException {
    ...
    synchronized(ADBM.class){
      ...
      if(val == null) throw new VillaException(vlecode());
      return val;
    }
  }
  /**
  ...
  public Object getobj(Object key) throws VillaException {
    byte[] kbuf = Util.serialize(key);
    if(kbuf == null) throw new VillaException();
    Object val = Util.deserialize(get(kbuf));
   ...
   * @param key a byte array of a key.
   * @return the size of the value of the corresponding record.  If no record corresponds, -1 is
   * returned.  If multiple records correspond, the size of the first is returned.
   * @throws VillaException if an error occurs.
   */
   ...
   */
  public void curfirst() throws VillaException {
    if(index < 0) throw new VillaException();
    synchronized(ADBM.class){
      if(vlcurfirst(index) == 0) throw new VillaException(vlecode());
    }
  }
  /**
   ...
   * @throws VillaException if an error occurs or there is no record in the database.
   */
  public void curlast() throws VillaException {
    if(index < 0) throw new VillaException();
    synchronized(ADBM.class){
      if(vlcurlast(index) == 0) throw new VillaException(vlecode());
    }
  }
  /**
   ...
   */
  public void curprev() throws VillaException {
    if(index < 0) throw new VillaException();
    synchronized(ADBM.class){
      if(vlcurprev(index) == 0) throw new VillaException(vlecode());
    }
  }
  /**
   * Move the cursor to the next record.
   ...
   */
  public void curnext() throws VillaException {
    if(index < 0) throw new VillaException();
    synchronized(ADBM.class){
      if(vlcurnext(index) == 0) throw new VillaException(vlecode());
    }
  }
  /**
   ...
   */
  public void curjump(byte[] key, int jmode) throws VillaException {
    if(index < 0) throw new VillaException();
    synchronized(ADBM.class){
   ...
   */
  public void curjump(byte[] key) throws VillaException {
    curjump(key, JFORWARD);
  }
  /**
  ...
  public Object curkeyobj() throws VillaException {
    Object key = Util.deserialize(curkey());
  ...
  public Object curvalobj() throws VillaException {
    Object val = Util.deserialize(curval());
    if(val == null) throw new VillaException();
    return val;
  }
  /**
   ...
   */
  public void curput(byte[] val, int cpmode) throws VillaException {
    if(index < 0) throw new VillaException();
    synchronized(ADBM.class){
      if(vlcurput(index, val, val.length, cpmode) == 0) throw new VillaException(vlecode());
    }
  }
  /**
   ...
   * @see #curput(byte[], int)
   */
  public void curput(byte[] val) throws VillaException {
    curput(val, CPCURRENT);
  }
  /**
   * Insert a record around the cursor.
   ...
   * @see #curput(byte[], int)
   */
  public void curputobj(Object val, int cpmode) throws VillaException {
    byte[] vbuf = Util.serialize(val);
   ...
   */
  public void curout() throws VillaException {
    if(index < 0) throw new VillaException();
    synchronized(ADBM.class){
      if(vlcurout(index) == 0) throw new VillaException(vlecode());
    }
  }
  /**
  ...
  public void store(byte[] key, byte[] val, boolean replace) throws VillaException {
    put(key, val, replace ? DOVER : DKEEP);
  }
  /**
   * Delete a record.
   * @param key a byte array of a key.
