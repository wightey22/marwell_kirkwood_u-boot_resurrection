...
#define DEVICE_CS1_BASE 0xf9000000
...
#ifdef MV78200
#define DEVICE_SPI_BASE DEVICE_CS2_BASE
#define DEVICE_SPI_SIZE DEVICE_CS2_SIZE
#else
...
#define BOOTDEV_CS_BASE	((0xFFFFFFFF - BOOTDEV_CS_SIZE) + 1)
#else
#define DEVICE_SPI_BASE ((0xFFFFFFFF - _8M) + 1)
#define DEVICE_SPI_SIZE _8M
#define BOOTDEV_CS_BASE	DEVICE_CS2_BASE
#endif
#endif /* MV632X */
...
#else
#define CFG_NAND_BASE   DEVICE_CS3_BASE
#endif
#else
#define CFG_NAND_BASE   DEVICE_CS2_BASE
#endif
...
#if defined(DB_MV78XX0) || defined(MV78200) || defined(RD_MV78XX0_PCAC)
...
/*     	base low      base high      size        	WinNum		enable/disable */ \
	...
	{{DEVICE_SPI_BASE,    0,      DEVICE_SPI_SIZE}, 12,		EN },/*  7 */ \
	{{PCI0_IO_BASE   ,    0,      PCI0_IO_SIZE   }, 0,		DIS },/*  9 */ \
	{{PCI0_MEM0_BASE ,    0,      PCI0_MEM0_SIZE }, 0,		EN },/* 10 */ \
	{{PCI1_IO_BASE   ,    0,      PCI1_IO_SIZE   }, 1,		DIS },/* 11 */ \
	{{PCI1_MEM0_BASE ,    0,      PCI1_MEM0_SIZE }, 1,		EN },/* 12 */ \
	{{PCI2_IO_BASE   ,    0,      PCI2_IO_SIZE   }, 2,		DIS},/* 13 */ \
	{{PCI2_MEM0_BASE ,    0,      PCI2_MEM0_SIZE }, 2,		EN},/* 14 */ \
	{{PCI3_IO_BASE   ,    0,      PCI3_IO_SIZE   }, 3,		DIS },/* 15 */ \
	{{PCI3_MEM0_BASE ,    0,      PCI3_MEM0_SIZE }, 3,		EN },/* 16 */ \
	{{PCI4_IO_BASE   ,    0,      PCI4_IO_SIZE   }, 4,		DIS },/* 17 */ \
	{{PCI4_MEM0_BASE ,    0,      PCI4_MEM0_SIZE }, 4,		EN },/* 18 */ \
	{{PCI5_IO_BASE   ,    0,      PCI5_IO_SIZE   }, 5,		DIS},/* 19 */ \
	{{PCI5_MEM0_BASE ,    0,      PCI5_MEM0_SIZE }, 5,		EN},/* 20 */ \
	{{PCI6_IO_BASE   ,    0,      PCI6_IO_SIZE   }, 6,		DIS},/* 21 */ \
	{{PCI6_MEM0_BASE ,    0,      PCI6_MEM0_SIZE }, 6,		EN},/* 22 */ \
	{{PCI7_IO_BASE   ,    0,      PCI7_IO_SIZE   }, 7,		DIS},/* 23 */ \
	{{PCI7_MEM0_BASE ,    0,      PCI7_MEM0_SIZE }, 7,		EN},/* 24 */ \
...
/*     	base low      base high      size        	WinNum		enable/disable */ \
	...
	{{DEVICE_SPI_BASE,    0,      DEVICE_SPI_SIZE}, 12,		EN },/*  7 */ \
	{{PCI0_IO_BASE   ,    0,      PCI0_IO_SIZE   }, 0,		DIS },/*  9 */ \
	{{PCI0_MEM0_ME_BASE,  0,      PCI0_MEM0_ME_SIZE }, 0,		EN },/* 10 */ \
	{{PCI1_IO_BASE   ,    0,      PCI1_IO_SIZE   }, 1,		DIS },/* 11 */ \
	{{PCI1_MEM0_ME_BASE,  0,      PCI1_MEM0_ME_SIZE }, 1,		EN },/* 12 */ \
	{{PCI2_IO_BASE   ,    0,      PCI2_IO_SIZE   }, 2,		DIS},/* 13 */ \
	{{PCI2_MEM0_ME_BASE,  0,      PCI2_MEM0_ME_SIZE }, 2,		EN},/* 14 */ \
	{{PCI3_IO_BASE   ,    0,      PCI3_IO_SIZE   }, 3,		DIS },/* 15 */ \
	{{PCI3_MEM0_ME_BASE,  0,      PCI3_MEM0_ME_SIZE }, 3,		EN },/* 16 */ \
	{{PCI4_IO_BASE   ,    0,      PCI4_IO_SIZE   }, 4,		DIS },/* 17 */ \
	{{PCI4_MEM0_ME_BASE,  0,      PCI4_MEM0_ME_SIZE }, 4,		EN },/* 18 */ \
	{{PCI5_IO_BASE   ,    0,      PCI5_IO_SIZE   }, 5,		DIS},/* 19 */ \
	{{PCI5_MEM0_ME_BASE,  0,      PCI5_MEM0_ME_SIZE }, 5,		EN},/* 20 */ \
	{{PCI6_IO_BASE   ,    0,      PCI6_IO_SIZE   }, 6,		DIS},/* 21 */ \
	{{PCI6_MEM0_ME_BASE,  0,      PCI6_MEM0_ME_SIZE }, 6,		EN},/* 22 */ \
	{{PCI7_IO_BASE   ,    0,      PCI7_IO_SIZE   }, 7,		DIS},/* 23 */ \
	{{PCI7_MEM0_ME_BASE,  0,      PCI7_MEM0_ME_SIZE }, 7,		EN},/* 24 */ \
	{{CRYPTO_BASE ,	      0,      CRYPTO_SIZE    }, 8,		EN },/* 25 */ \
	{{INTER_REGS_BASE,    0,      INTER_REGS_SIZE}, 14,		EN },/* 26 */ \
    	/* Table terminator */ \
   	{{TBL_TERM, TBL_TERM, TBL_TERM}, TBL_TERM, TBL_TERM} \
...
/*     	base low      base high      size        	WinNum		enable/disable */ \
	...
	{{PCI2_IO_BASE   ,    0,      PCI2_IO_SIZE   }, 4,		DIS},/* 13 */ \
	{{PCI2_MEM0_BASE ,    0,      PCI2_MEM0_ME_SIZE }, 5,		DIS},/* 14 */ \
	{{PCI3_IO_BASE   ,    0,      PCI3_IO_SIZE   }, 4,		DIS },/* 15 */ \
...
/*     	base low      base high      size        	WinNum		enable/disable */ \
	...
	{{PCI0_MEM0_ME_BASE,  0,      PCI0_MEM0_ME_SIZE }, 1,		EN },/* 10 */ \
	{{PCI1_IO_BASE   ,    0,      PCI1_IO_SIZE   }, 2,		EN },/* 11 */ \
	{{PCI1_MEM0_ME_BASE,  0,      PCI1_MEM0_ME_SIZE }, 3,		EN },/* 12 */ \
	{{PCI2_IO_BASE   ,    0,      PCI2_IO_SIZE   }, 4,		DIS},/* 13 */ \
	{{PCI2_MEM0_BASE ,    0,      PCI2_MEM0_ME_SIZE }, 5,		DIS},/* 14 */ \
	{{PCI3_IO_BASE   ,    0,      PCI3_IO_SIZE   }, 4,		EN },/* 15 */ \
	{{PCI3_MEM0_ME_BASE,  0,      PCI3_MEM0_ME_SIZE }, 5,		EN },/* 16 */ \
	{{PCI4_IO_BASE   ,    0,      PCI4_IO_SIZE   }, 6,		EN },/* 17 */ \
	{{PCI4_MEM0_ME_BASE,  0,      PCI4_MEM0_ME_SIZE }, 7,		EN },/* 18 */ \
	{{PCI5_IO_BASE   ,    0,      PCI5_IO_SIZE   }, 5,		DIS},/* 19 */ \
	{{PCI5_MEM0_ME_BASE , 0,      PCI5_MEM0_ME_SIZE }, 5,		DIS},/* 20 */ \
