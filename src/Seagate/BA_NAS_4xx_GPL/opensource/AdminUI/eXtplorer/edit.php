...
/**
 * @version $Id: edit.php,v 1.2 2007/09/05 09:24:51 wiley Exp $
 * @package eXtplorer
  ...
  <div style="width:auto;">
      ...
      <div class="x-box-ml"><div class="x-box-mr"><div class="x-box-mc">
          ...
          <h3 style="margin-bottom:5px;"><?php
            echo ext_Lang::msg('actedit').": /".$s_item .'&nbsp;&nbsp;&nbsp;&nbsp;';
            echo '[<a href="javascript:;" onclick="Ext.get(\'positionIndicator\').toggle(); ext_codefield.toggleEditor();return false;">'.ext_Lang::msg('editor_simple').' / '.ext_Lang::msg('editor_syntaxhighlight').'</a>]';
            ?></h3>
      <div id="positionIndicator">
    <?php echo ext_Lang::msg('line') ?>: <input type="text" value="" name="txtLine" id="txtLine" class="inputbox" size="6" onchange="setCaretPosition( codetextarea, this.value);return false;" />&nbsp;&nbsp;&nbsp;
    <?php echo ext_Lang::msg('column') ?>: <input type="text" value="" name="txtColumn" id="txtColumn" class="inputbox" size="6" readonly="readonly" />
    </div>
    <br />
