<?php
/**
* @version $Id: standalone.php,v 1.5 2007/11/07 09:44:18 wiley Exp $
* @package eXtplorer
...
require_once( dirname( __FILE__ ) .'/../include/shares.php' );
...
class extMainFrame {
  ...
  */
  function extMainFrame() {
    ...
    $this->_head = array();
    $this->_head['title']  = $GLOBALS["__LANGUAGE"]["messages"]["explorer"];
