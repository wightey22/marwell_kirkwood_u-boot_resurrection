/*
 * "$Id: auth.c,v 1.1.1.1.12.1 2009/02/03 08:27:04 wiley Exp $"
 *
...
cups_local_auth(http_t *http)		/* I - HTTP connection to server */
{
  ...
  */
  ...
  static char	certificate[33];	/* Certificate string */
...
/*
 * End of "$Id: auth.c,v 1.1.1.1.12.1 2009/02/03 08:27:04 wiley Exp $".
 */
