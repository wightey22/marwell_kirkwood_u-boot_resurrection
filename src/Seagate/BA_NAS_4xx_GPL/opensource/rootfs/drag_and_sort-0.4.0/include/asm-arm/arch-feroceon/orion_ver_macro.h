...
mv_orion_has_vfp_address:
  	.word   mv_orion_has_vfp

.macro	mv_check_orion_has_vfp, rd
        ldr     \rd, mv_orion_has_vfp_address 
	ldr     \rd, [\rd]
	.endm

mv_vfp_always_on_address:
  	.word   mv_vfp_always_on

.macro	mv_check_vfp_always_on, rd
        ldr     \rd, mv_vfp_always_on_address 
	ldr     \rd, [\rd]
	.endm
