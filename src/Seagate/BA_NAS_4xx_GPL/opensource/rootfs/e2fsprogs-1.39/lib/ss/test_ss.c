 ...
 *------------------------------------------------------------------
 *
 * $Source: /var/cvs/proto/marvell_5182/package/e2fsprogs/e2fsprogs-1.39/lib/ss/test_ss.c,v $
 * $Revision: 1.1.1.1 $
 * $Date: 2007/03/20 02:30:58 $
 * $State: Exp $
 * $Author: jason $
 * $Locker:  $
 *
 * $Log: test_ss.c,v $
 * Revision 1.1.1.1  2007/03/20 02:30:58  jason
 * new version
 *
...
static char const rcsid_test_c[] =
    "$Header: /var/cvs/proto/marvell_5182/package/e2fsprogs/e2fsprogs-1.39/lib/ss/test_ss.c,v 1.1.1.1 2007/03/20 02:30:58 jason Exp $";
#endif /* lint */
