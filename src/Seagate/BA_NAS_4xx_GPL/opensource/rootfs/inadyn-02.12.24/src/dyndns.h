...
#define DYNDNS_MT_DEFAULT_CONFIG_FILE	"/etc/inadyn-mt/inadyn-mt.conf"
...
typedef struct DYN_DNS_CLIENT
{
	...
	int	time_sleep_lost_ms; /*period can be interrupted by signal, so update this*/
