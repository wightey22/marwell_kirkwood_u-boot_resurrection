 ...
 * 
 * $Header: /var/cvs/proto/marvell_5182/package/krb5/krb5-1.4.3/src/kadmin/passwd/kpasswd.c,v 1.1.1.1 2006/05/19 07:08:18 arsene Exp $
 *
 *
 */

static char rcsid[] = "$Id: kpasswd.c,v 1.1.1.1 2006/05/19 07:08:18 arsene Exp $";
