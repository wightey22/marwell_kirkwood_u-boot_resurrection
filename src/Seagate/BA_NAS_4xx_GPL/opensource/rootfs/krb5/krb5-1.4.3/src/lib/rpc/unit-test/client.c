 ...
 *
 * $Id: client.c,v 1.1.1.1 2006/05/19 07:08:15 arsene Exp $
 *
 */

#if !defined(lint) && !defined(__CODECENTER__)
static char *rcsid = "$Header: /var/cvs/proto/marvell_5182/package/krb5/krb5-1.4.3/src/lib/rpc/unit-test/client.c,v 1.1.1.1 2006/05/19 07:08:15 arsene Exp $";
#endif
