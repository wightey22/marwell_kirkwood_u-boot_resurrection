 ...
 *
 * $Id: rpc_test.x,v 1.1.1.1 2006/05/19 07:08:15 arsene Exp $
 * $Source: /var/cvs/proto/marvell_5182/package/krb5/krb5-1.4.3/src/lib/rpc/unit-test/rpc_test.x,v $
 * 
 * $Log: rpc_test.x,v $
 * Revision 1.1.1.1  2006/05/19 07:08:15  arsene
 * kerberos5 source
 *
