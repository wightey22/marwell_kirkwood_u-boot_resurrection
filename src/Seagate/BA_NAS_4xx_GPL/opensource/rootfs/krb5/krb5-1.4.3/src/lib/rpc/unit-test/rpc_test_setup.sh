...
# environment. 
#
# $Id: rpc_test_setup.sh,v 1.1.1.1 2006/05/19 07:08:15 arsene Exp $
# $Source: /var/cvs/proto/marvell_5182/package/krb5/krb5-1.4.3/src/lib/rpc/unit-test/rpc_test_setup.sh,v $
