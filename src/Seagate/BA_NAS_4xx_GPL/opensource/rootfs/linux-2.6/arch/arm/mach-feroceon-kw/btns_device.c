...
static struct btn_data                  btn_data_shasta[] = {
        [0] = {
                .gpp_id         = 14,	//LCM Switch down
                .default_gpp_val= 0x0,	//low==>PUSH
                .btn_op         = BTN_CHANGE,
                .btn_name       = "DOWN",
        },
        [1] = {
                .gpp_id         = 47,	//LCM Switch down
                .default_gpp_val= 0x0,	//low==>PUSH
                .btn_op         = BTN_CHANGE,
                .btn_name       = "UP",
        },
...
//BOARD_1A +
static struct btn_data                  btn_data_shasta_1a[] = {
        [0] = {
                .gpp_id         = 34,	//LCM Switch down
                .default_gpp_val= 0x0,	//low==>PUSH
                .btn_op         = BTN_CHANGE,
                .btn_name       = "DOWN",
        },
...
static int btns_init_data(struct platform_device *pdev)
{
	switch(mvBoardIdGet()) {
		...
		case DB_88F6281A_BP_ID:
			dprintk("%s - SHASTA board \n", __FUNCTION__);
//BOARD_1A +
extern int shasta_board_sample_1b;
			if (shasta_board_sample_1b == 0)
			    btns_data.btns_data_arr = btn_data_shasta_1a;
			else
//BOARD_1A -
			btns_data.btns_data_arr = btn_data_shasta;
			btns_data.btns_num = (btns_data.btns_data_arr == NULL) ? 
						0 : ARRAY_SIZE(btn_data_shasta);
