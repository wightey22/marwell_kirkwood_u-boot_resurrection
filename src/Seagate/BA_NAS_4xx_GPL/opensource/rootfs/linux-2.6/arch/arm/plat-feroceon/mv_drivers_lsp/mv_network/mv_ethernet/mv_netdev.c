 ...
 *                   structure                             *
 ***********************************************************/
//nick struct net_device* __init mv_netdev_init(mv_eth_priv *priv, int mtu, u8* mac)
struct net_device* __init mv_netdev_init(mv_eth_priv *priv, int mtu, u8* mac, int net_no)      //nick
{
...
//nick +
       {
//             char name_str[]="egiga";
//             strncpy(dev->name, "egigax", 6);
               sprintf(dev->name, "egiga%1.1d", net_no);
       }
//nick -
    mv_netdev_set_features(dev);
...
//nick            mv_net_devs[netdev] = mv_netdev_init(priv, mtu, mac_addr);
            mv_net_devs[netdev] = mv_netdev_init(priv, mtu, mac_addr, netdev); //nick
