...
//SHASTA_BOARD void mvScsiReadDefectData(PCore_Driver_Extension pCore, PMV_Request req);
//SHASTA_BOARD void  mvScsiLogSenseTranslation(PCore_Driver_Extension pCore,  PMV_Request pReq);
//SHASTA_BOARD MV_BOOLEAN mvScsiModeSelect(PCore_Driver_Extension pCore, PMV_Request pReq);
//SHASTA_BOARD void mvScsiModeSense(PCore_Driver_Extension pCore, PMV_Request pReq);
//SHASTA_BOARD void Core_Fill_SendDiagTaskfile( PDomain_Device device,PMV_Request req, PATA_TaskFile taskfile);
