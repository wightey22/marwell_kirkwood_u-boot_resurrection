cmd_fs/xfs/xfs_utils.o := arm-none-linux-gnueabi-gcc -Wp,-MD,fs/xfs/.xfs_utils.o.d  -nostdinc -isystem /opt/devel/proto/marvell/build-eabi/kernel-toolchain/bin/../lib/gcc/arm-none-linux-gnueabi/4.2.1/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Os -marm -ffunction-sections                         -fno-omit-frame-pointer -mapcs -mno-sched-prolog -mabi=aapcs-linux -mno-thumb-interwork -D__LINUX_ARM_ARCH__=5 -march=armv5t -mtune=marvell-f  -msoft-float -Uarm -fno-omit-frame-pointer -fno-optimize-sibling-calls  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign -Ifs/xfs -Ifs/xfs/linux-2.6 -funsigned-char   -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(xfs_utils)"  -D"KBUILD_MODNAME=KBUILD_STR(xfs)" -c -o fs/xfs/xfs_utils.o fs/xfs/xfs_utils.c
