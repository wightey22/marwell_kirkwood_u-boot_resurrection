...
"Overview\n"
"--------\n"
"Some features may be built directly into MV88f5181.  Some features\n"
...
load_config_help[] =
	"\n"
	"For various reasons, one may wish to keep several different MV88f5181\n"
	"configurations available on a single machine.\n"
	"\n"
	"If you have saved a previous configuration in a file other than the\n"
	"MV88f5181's default, entering the name of the file here will allow you\n"
...
save_config_help[] =
	"\n"
	"For various reasons, one may wish to keep different MV88f5181\n"
	"configurations available on a single machine.\n"
	"\n"
...
int main(int ac, char **av)
{
	...
	snprintf(menu_backtitle, 128, "MV88f5181 Configuration");
	...
	do {
		stat = dialog_yesno(NULL,
				    "Do you wish to save your new MV88f5181 configuration?", 5, 60);
	} while (stat < 0);
	end_dialog();
	...
	if (stat == 0) {
		conf_write(NULL);
		printf("\n\n"
			"*** End of MV88f5181 configuration.\n"
			"*** Check the top-level Makefile for additional configuration options.\n\n");
	} else
		printf("\n\nYour MV88f5181 configuration changes were NOT saved.\n\n");
