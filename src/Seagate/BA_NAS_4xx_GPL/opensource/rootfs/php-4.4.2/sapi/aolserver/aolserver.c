...
/* $Id: aolserver.c,v 1.1.1.1 2006/03/24 06:13:42 wiley Exp $ */
...
static void php_info_aolserver(ZEND_MODULE_INFO_FUNC_ARGS)
{
	...
	php_info_print_table_row(2, "SAPI module version", "$Id: aolserver.c,v 1.1.1.1 2006/03/24 06:13:42 wiley Exp $");
