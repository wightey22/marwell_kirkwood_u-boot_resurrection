...
/* $Id: caudium.c,v 1.1.1.1 2006/03/24 06:13:43 wiley Exp $ */
...
static void php_info_caudium(ZEND_MODULE_INFO_FUNC_ARGS)
{
  ...
  php_info_print_table_row(2, "SAPI module version", "$Id: caudium.c,v 1.1.1.1 2006/03/24 06:13:43 wiley Exp $");
