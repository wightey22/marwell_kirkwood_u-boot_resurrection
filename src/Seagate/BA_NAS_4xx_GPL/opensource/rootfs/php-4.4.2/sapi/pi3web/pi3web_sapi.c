...
/* $Id: pi3web_sapi.c,v 1.1.1.1 2006/03/24 06:13:43 wiley Exp $ */
...
static void php_info_pi3web(ZEND_MODULE_INFO_FUNC_ARGS)
{
	...
	php_info_print_table_row(2, "Pi3Web SAPI module version", "$Id: pi3web_sapi.c,v 1.1.1.1 2006/03/24 06:13:43 wiley Exp $");
