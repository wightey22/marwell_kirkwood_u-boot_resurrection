...
if test -n "$HAVE_YODL2MAN"; then
  { echo "$as_me:$LINENO: result: $HAVE_YODL2MAN" >&5
echo "${ECHO_T}$HAVE_YODL2MAN" >&6; }
else
  { echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6; }
fi
...
/* end confdefs.h.  */
$ac_includes_default
typedef struct stat64 ac__type_new_;
int
main ()
{
if ((ac__type_new_ *) 0)
...
{ echo "$as_me:$LINENO: result: $ac_cv_type_struct_stat64" >&5
echo "${ECHO_T}$ac_cv_type_struct_stat64" >&6; }
if test $ac_cv_type_struct_stat64 = yes; then
...
if test x"$ac_cv_func_iconv_open" != x"yes"; then
    { echo "$as_me:$LINENO: checking for libiconv_open" >&5
echo $ECHO_N "checking for libiconv_open... $ECHO_C" >&6; }
...
{ echo "$as_me:$LINENO: result: $ac_cv_func_libiconv_open" >&5
echo "${ECHO_T}$ac_cv_func_libiconv_open" >&6; }
if test $ac_cv_func_libiconv_open = yes; then
...
{ echo "$as_me:$LINENO: result: $rsync_cv_HAVE_STRUCT_UTIMBUF" >&5
echo "${ECHO_T}$rsync_cv_HAVE_STRUCT_UTIMBUF" >&6; }
...
_ACEOF
	...
	;;
    *)
	{ echo "$as_me:$LINENO: result: running tests:" >&5
echo "${ECHO_T}running tests:" >&6; }
...
echo "$as_me: error: Failed to find ACL support" >&2;}
   { (exit 1); exit 1; }; }
		...
		{ echo "$as_me:$LINENO: result: No ACL support found" >&5
echo "${ECHO_T}No ACL support found" >&6; }
	    fi
	fi
	;;
    esac
...
HAVE_YODL2MAN!$HAVE_YODL2MAN$ac_delim
