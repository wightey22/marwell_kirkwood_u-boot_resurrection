...
static const char *filenameandversion="$Id: os_linux.cpp,v 1.1.1.1.4.2 2008/11/26 07:31:04 wiley Exp $";

const char *os_XXXX_c_cvsid="$Id: os_linux.cpp,v 1.1.1.1.4.2 2008/11/26 07:31:04 wiley Exp $" \
...
//nick +
  case SEND_IDLE:
    buff[0]=MV_ATA_COMMAND_IDLE;
    buff[3]=select;
    break;
  case SEND_IDLE_IMMEDIATE:
    buff[0]=MV_ATA_COMMAND_IDLE_IMMEDIATE;
    break;
  case SEND_STANDBY:
    buff[0]=MV_ATA_COMMAND_STANDBY;
    buff[3]=select;
    break;
  case SEND_STANDBY_IMMEDIATE:
    buff[0]=MV_ATA_COMMAND_STANDBY_IMMEDIATE;
    break;
//nick -
