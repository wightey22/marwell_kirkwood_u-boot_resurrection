...
static const char *filenameandversion="$Id: os_solaris.cpp,v 1.1.1.1.4.2 2008/11/26 07:31:04 wiley Exp $";

const char *os_XXXX_c_cvsid="$Id: os_solaris.cpp,v 1.1.1.1.4.2 2008/11/26 07:31:04 wiley Exp $" \
