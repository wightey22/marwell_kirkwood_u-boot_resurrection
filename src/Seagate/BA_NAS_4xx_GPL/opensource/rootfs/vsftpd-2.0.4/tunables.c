...
int tunable_convert_charset_enable = 1;
int tunable_local_codepage = 1;
int tunable_share_acl_enable = 1;
...
unsigned int tunable_bind_retries = 10;
...
const char* tunable_remote_charset = "UTF-8";
const char* tunable_pasv_addr_rules = "/etc/vsftpd.pasv_rules";
const char* tunable_users_access_ip = "/etc/vsftpd.users_ip";
const char* tunable_share_acl_file = "/etc/vsftpd.share_acl";
