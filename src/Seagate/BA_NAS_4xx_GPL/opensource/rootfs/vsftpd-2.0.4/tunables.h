...
extern int tunable_share_acl_enable;          /* Enable share access control */
...
extern unsigned int tunable_bind_retries;              /* Count tries to bind port in passive mode */
...
extern const char* tunable_share_acl_file;
